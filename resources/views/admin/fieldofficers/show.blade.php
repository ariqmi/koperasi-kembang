<x-app-layout-admin title="Lihat FO">

  <!-- Content Start -->
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="title-large-dashboard mb-0">Lihat FO {{ $userfo->nama }}</h2>
    ...
    <div class="card p-3 shadow-sm">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 mx-auto">
          <a href="{{ route('admin.fieldofficers.edit', $userfo->user_id) }}" class="button-primary text-center mx-3 mt-2 d-block">Edit</a>
        </div>
